 ...
 * Input: { text: "customers who spent > 1000 and visited < 3 times" }
 * Output: { rules: [ { field: "totalSpending", operator: ">", value: 1000 }, ... ] }
 */
 ...
 * Input: { objective: "win back inactive users" }
 * Output: { messages: ["Hi {{name}}, ...", "We miss you {{name}}, ..."] }
 */
...
/**
 * POST /api/ai/summary
 * Input: { stats: { sent: 200, delivered: 180, failed: 20 } }
 * Output: { summary: "Your campaign reached 200 users..." }
 */
